...
class Pretrained_conv(nn.Module):
    def __init__(self, latent_dim):
        ...
        # self.conv_model = models.convnext_small(pretrained=True)
        self.conv_model = models.efficientnet_v2_m(pretrained=True)


        # print(self.conv_model)

        # print(self.conv_model.classifier[2])
        ...
        #convnext_small
        # self.conv_model.classifier[2] = nn.Linear(self.conv_model.classifier[2].in_features, latent_dim)

        # efficientnetv2-m
        self.conv_model.classifier[1] = nn.Linear(self.conv_model.classifier[1].in_features, latent_dim)
        # print(self.conv_model.classifier[2])
